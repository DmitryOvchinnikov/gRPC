//protoc -I $GOPATH/src/productinfo/service/ecommerce $GOPATH/src/productinfo/service/ecommerce/product_info.proto --go_out=plugins=grpc:$GOPATH/src/productinfo/service/ecommerce
